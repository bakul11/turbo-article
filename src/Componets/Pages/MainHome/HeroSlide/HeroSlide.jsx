                ...
                <div className="col-lg-6">
                    <Slide right>
                        <div className="content-banner mt-5">
                            <h2 className='fw-bold text-dark'>Read <span className='text-danger'>The Article</span> <br /> to gain Knowledge</h2>
                            <h4 className='mb-3 mt-3 fs-5 text-primary'>The world's most popular Article base platform</h4>
                            <h5 className='text-dark fs-6'>Turbo Dynamics connects a global community of 90 million readers and writers through the power of story.</h5>
