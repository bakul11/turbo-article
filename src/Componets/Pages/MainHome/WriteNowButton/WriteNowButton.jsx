...
const WriteNowButton = () => {
    ...
    useEffect(() => {
        const getCategory = async () => {
            const resCategory = await fetch('https://whispering-ridge-30056.herokuapp.com/article');
            const resCate = await resCategory.json();
            setCategories(await resCate);
        }
        getCategory();
    }, []);
                        ...
                        <Slide left>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="row gy-2">
                                    ...
                                    <div className="col-lg-11">
                                        <input {...register("category", { required: true })} className='form-control' type='text' placeholder='Category' />
